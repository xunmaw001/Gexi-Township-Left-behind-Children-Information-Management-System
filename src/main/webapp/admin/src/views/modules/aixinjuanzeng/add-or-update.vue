<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="捐赠形式" prop="juanzengxingshi">
          <el-select v-model="ruleForm.juanzengxingshi" placeholder="请选择捐赠形式">
            <el-option
                v-for="(item,index) in juanzengxingshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="捐赠形式" prop="juanzengxingshi">
	      <el-input v-model="ruleForm.juanzengxingshi"
                placeholder="捐赠形式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠物品" prop="juanzengwupin">
          <el-input v-model="ruleForm.juanzengwupin" 
              placeholder="捐赠物品" clearable  :readonly="ro.juanzengwupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠物品" prop="juanzengwupin">
              <el-input v-model="ruleForm.juanzengwupin" 
                placeholder="捐赠物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='juanzengxingshi'){
            this.ruleForm.juanzengxingshi = obj[o];
	    this.ro.juanzengxingshi = true;
            continue;
          }
          if(o=='juanzengwupin'){
            this.ruleForm.juanzengwupin = obj[o];
	    this.ro.juanzengwupin = true;
            continue;
          }
          if(o=='juankuanjine'){
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.juanzengxingshiOptions = "企业,个人".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
