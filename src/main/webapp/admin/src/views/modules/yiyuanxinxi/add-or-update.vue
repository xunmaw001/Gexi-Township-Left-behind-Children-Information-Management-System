<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院设施" prop="yiyuansheshi">
          <el-input v-model="ruleForm.yiyuansheshi" 
              placeholder="医院设施" clearable  :readonly="ro.yiyuansheshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院设施" prop="yiyuansheshi">
              <el-input v-model="ruleForm.yiyuansheshi" 
                placeholder="医院设施" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医院详情" prop="yiyuanxiangqing">
          <el-input v-model="ruleForm.yiyuanxiangqing" 
              placeholder="医院详情" clearable  :readonly="ro.yiyuanxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医院详情" prop="yiyuanxiangqing">
              <el-input v-model="ruleForm.yiyuanxiangqing" 
                placeholder="医院详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuantupian = true;
          ...
          if(o=='yiyuansheshi'){
            this.ruleForm.yiyuansheshi = obj[o];
	    this.ro.yiyuansheshi = true;
            continue;
          }
